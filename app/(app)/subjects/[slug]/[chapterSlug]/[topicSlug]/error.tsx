...
/**
 * Error state for /subjects/[slug]/[chapterSlug]/[topicSlug].
 *
 * Mirrors the chapter error state pattern with the same
 * cockpit-card language, French-language-tinted warning chip,
 * and the dual exit (try again + back to chapter). Keeps the
 * user off the raw browser error path.
 */
        ...
        <div className="grid grid-cols-1 items-center gap-6 sm:grid-cols-[auto,1fr]">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="max-w-md text-[13px] leading-relaxed text-muted-foreground">
              The topic view failed to render. This is usually a
              temporary connection issue. Your progress is safe.
            </p>
            {error.digest && (
